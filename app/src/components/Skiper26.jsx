...
const Skiper26 = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "relative flex h-full w-full flex-col items-center justify-center" }, /* @__PURE__ */ React.createElement("div", { className: "mx-auto max-w-lg space-y-5" }, /* @__PURE__ */ React.createElement("h2", { className: "mt-36 text-4xl font-medium tracking-tight" }, "07.09.2025 ", /* @__PURE__ */ React.createElement("br", null), "Skiper ui is live now"), /* @__PURE__ */ React.createElement("p", null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil, ex eligendi veniam praesentium temporibus natus quae laborum nemo repellendus cum!"), /* @__PURE__ */ React.createElement("p", null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil, ex eligendi veniam praesentium temporibus natus quae laborum nemo repellendus cum!"), /* @__PURE__ */ React.createElement("p", null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil, ex eligendi veniam praesentium temporibus natus quae laborum nemo repellendus cum!")), /* @__PURE__ */ React.createElement("div", { className: "text-foreground grid content-start justify-items-center gap-6 py-20 text-center" }, /* @__PURE__ */ React.createElement("span", { className: "after:from-background after:to-foreground relative max-w-[12ch] text-xs uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:content-['']" }, "Click to toggle the theme")), /* @__PURE__ */ React.createElement(
    ThemeToggleButton,
    {
      variant,
      start,
...
const Options = ({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("span", { className: "size-4 cursor-grab active:cursor-grabbing" }, /* @__PURE__ */ React.createElement(GripHorizontal, { className: "size-4 opacity-50" })), /* @__PURE__ */ React.createElement("p", { className: "group flex cursor-pointer items-center justify-center gap-1 rounded-lg px-2 py-1 text-sm opacity-50" }, "Options")),
    /* @__PURE__ */ React.createElement("div", { className: "flex flex-col" }, /* @__PURE__ */ React.createElement("div", { className: "mt-1 flex justify-between py-1" }, /* @__PURE__ */ React.createElement("p", { className: "w-20 whitespace-nowrap text-sm opacity-50" }, "variant :"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center justify-end gap-1" }, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "circle-blur"
    ))), /* @__PURE__ */ React.createElement("div", { className: "mt-1 flex justify-between py-1" }, /* @__PURE__ */ React.createElement("p", { className: "w-20 whitespace-nowrap text-sm opacity-50" }, "blur :"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center justify-end gap-1" }, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "on"
    ))), (variant === "circle" || variant === "rectangle" || variant === "polygon" || variant === "circle-blur") && /* @__PURE__ */ React.createElement("div", { className: "mt-1 flex justify-between py-1" }, /* @__PURE__ */ React.createElement("p", { className: "w-20 whitespace-nowrap text-sm opacity-50" }, "start :"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center justify-end gap-1" }, (variant === "circle" || variant === "circle-blur") && /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "center"
    ), variant === "rectangle" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "right-left"
    )), (variant === "circle" || variant === "polygon" || variant === "circle-blur") && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "top-right"
    ), variant !== "polygon" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => setStart("bottom-left"),
        className: cn(
          "cursor-pointer px-1 text-sm transition-opacity",
          start === "bottom-left" ? "opacity-100" : "hover:bg-foreground/10 opacity-50 hover:opacity-100"
        )
      },
      "bottom-left"
    ), /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        className: cn(
          "cursor-pointer px-1 text-sm transition-opacity",
          start === "bottom-right" ? "opacity-100" : "hover:bg-foreground/10 opacity-50 hover:opacity-100"
        )
      },
      "bottom-right"
    ))), (variant === "circle" || variant === "circle-blur") && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "bottom-center"
    )))), variant === "gif" && /* @__PURE__ */ React.createElement("div", { className: "mt-1 flex justify-between py-1" }, /* @__PURE__ */ React.createElement("p", { className: "w-20 text-sm opacity-50" }, "gif type :"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center justify-end gap-1" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
          setGifType("1");
      ...
      "custom"
    ))), variant === "gif" && gifType === "custom" && /* @__PURE__ */ React.createElement("div", { className: "mt-1 flex flex-col gap-1 py-1" }, /* @__PURE__ */ React.createElement("p", { className: "text-sm opacity-50" }, "gif url :"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        value: gifUrl,
...
export const ThemeToggleButton = ({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 240 240", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, /* @__PURE__ */ React.createElement(
      motion.g,
      {
...
const generateSVG = (variant, start) => {
  if (variant === "circle-blur") {
    ...
    const positionCoords2 = getPositionCoords(start);
    if (!positionCoords2) {
      throw new Error(`Invalid start position: ${start}`);
    }
    const { cx: cx2, cy: cy2 } = positionCoords2;
    return `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><defs><filter id="blur"><feGaussianBlur stdDeviation="2"/></filter></defs><circle cx="${cx2}" cy="${cy2}" r="18" fill="white" filter="url(%23blur)"/></svg>`;
  }
